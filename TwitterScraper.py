...
'''
Inspired by: https://github.com/tomkdickinson/Twitter-Search-API-Python
It's suitable as an example of how you can extract Tweets from Twitter, 
without going through their API and obtaining theoretically much large 
datasets.

Sincere thanks to Tom Dickinson
'''
import requests
import json
import datetime
...
class TwitterSearchImpl(TwitterSearch):
    ...
    def __init__(self, rate_delay, error_delay, max_tweets, save_path="./saved_tweet.pkl", print_tweets=False):
        """
        :param rate_delay: How long to pause between calls to Twitter
        :param error_delay: How long to pause when an error occurs
        ...
        self.print_tweets = print_tweets
...
class TwitterSlicer(TwitterSearch):
    ...
    """
    def __init__(self, rate_delay, error_delay, since, until, n_threads=1, save_path="./saved_tweet.pkl", print_tweets=False):
        ...
        self.save_path = save_path
        self.print_tweets = print_tweets
        # open the file where to save all tweets
        empty_list = []
        pickle.dump(empty_list, open(self.save_path, "wb"))
    ...
    def save_tweets(self, tweets):
        ...
        :return: True always
        """
        # open the tweets save path and extend list of tweets
        all_tweets = pickle.load(open(self.save_path, "rb"))
        all_tweets.extend(tweets)
        
        # save with the added tweets
        pickle.dump(all_tweets, open(self.save_path, "wb"))
